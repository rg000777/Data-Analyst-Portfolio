Hi, I'm Rohit Gaur — Aspiring Data Analyst
...
Key Highlights:
📊 Total Revenue tracked: ₹12.47M
🔍 Churn Risk segmentation by Membership Tier (Free → Platinum)
📍 Revenue By Country via interactive world map
📣 Acquisition Channel analysis — Organic Search drove highest spend
...
Key Highlights:
📈 AI Replacement Score trend: sharp spike post-2024
⚙️ Automation Risk breakdown: Medium > High > Low
💰 Avg Salary Before vs After disruption tracked
🏭 Industry distribution: Finance, Energy, Technology, Retail, Transportation
...
Key Highlights:
💵 Total Revenue: ₹5.47M
🌍 Regional breakdown: Asia, North America, Europe, Middle East
📦 Category slicer: Electronics, Fashion, Beauty, Books, Sports, Home & Kitchen
...
Key Highlights:
🧠 Perceptual Filter & internal/external buying influence analysis
🔄 Types of consumer purchase decisions mapped
🏭 Indian automobile industry SWOT (Maruti, Tata, Hyundai, Bajaj)
...
Key Highlights:
🎯 4Ps analysis: QR-based product suite, zero-fee pricing, 400+ city distribution
🏏 Cricket-led campaigns: "Ek Bharat Ek QR" & "Team BharatPe"
💳 Products covered: BharatPe Swipe, 12% Club, Digital Gold, BharatX
📊 SWOT: Collateral-free lending (Strength) vs UPI dependency (Risk)
...
🤖 Microsoft Excel with AI — Udemy
🛠️ be10x AI Tools Workshop
   Python (Udemy)
   Prompt Engineering 
   IIT Delhi EDC 
...
Open to Data Analyst opportunities in Delhi/NCR/Noida. Let's build something data-driven together! 🚀